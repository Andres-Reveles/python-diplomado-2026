...
from archivos_productos_json import cargar_productos_json, guardar_productos_json


NOMBRE_ARCHIVO = "productos_inventario.json"


print("=== Proyecto inventario de productos con JSON ===")
...
productos = cargar_productos_json(NOMBRE_ARCHIVO)
...
while True:
    ...
    if opcion == "1":
        ...
        guardar_productos_json(productos, NOMBRE_ARCHIVO)
