from modelos.alumno import crear_alumno, mostrar_alumno
from servicios.alumno_servicio import (
    buscar_alumno,
    matricula_disponible,
    calcular_promedio,
    obtener_estado
)
from utilidades.entradas import pedir_texto_no_vacio, pedir_float_rango
from reportes.reporte_grupo import mostrar_reporte_grupo


print("=== Sistema de calificaciones con paquetes ===")
